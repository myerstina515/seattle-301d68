...
function displayPics(){
  ...
  // By changing var to "let", it made 'rando' only accessible inside the function in which it was declared. 'Let' assumes 'rando' will only be used in the code block it was created in, making it unusable outside of the function (code block) it was assigned in.
  console.log(viewed);
