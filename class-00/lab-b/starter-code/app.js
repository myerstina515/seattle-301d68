...
const sumOfNumbers = (a, b, c, d) => `${a + b + c + d}`;
...
const objectLitNewObject = ({
  key1: 'value1',
  key2: 'value2',
  key3: 'value3',
})

console.log(objectLitNewObject);
...
const sumAndProductTwo = (a, b) => `[${a + b}, ${a * b}]`;

console.log(sumAndProductTwo(3, 9));
...
const messageTwo = name => `Hello, ${name}!`;

console.log(messageTwo('Allie'));
...
// This instruction is unclear. I returned it to it's previous state after seeing the broken code. Should I then try to change it to a different arrow function that works?
...
// When joe.scope() is invoked, "this" is the instance "joe" and populates with all of his information
// 2. What is "this" when joe.scopeArrow() is invoked?
// When joe.scopeArrow()is invoked, the result is "Window" and references the global window object.
// 3. Explain why "this" is different when an arrow function is used.
// The arrow function does not behave appropriately with "this". Unless the arrow function is surrounded by a non arrow function, it will retain the value of the "enclosing functional scope".
